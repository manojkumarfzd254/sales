...
<section class="bg-gray-100 mb-20">
    <div class="container mx-auto flex px-1 sm:px-20 py-20 md:flex-row flex-col items-center">
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img class="object-cover object-center rounded" alt="hero" src="{{ asset('img/logo.svg') }}">
        </div>
        <div class="lg:flex-grow md:w-1/2 px-4 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <div class="flex justify-center">
                ...
                <a href="https://salesdata.in/" target="_blank" class="ml-4 outline outline-1 outline-gray-800 inline-flex text-gray-700 hover:text-gray-100 bg-gray-200 hover:bg-gray-700 py-2 px-6 focus:outline-none rounded text-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="w-8 h-8" viewBox="0 0 18 18">
    ...
    <div class="container mx-auto flex px-5 py-10 sm:py-24 items-center justify-center flex-col">
        <div class="text-center lg:w-2/3 w-full">
            ...
            <p class="mb-8 leading-relaxed">
                In the following section we listed a number of screenshots of different parts of the project, Sales Data.
            </p>
        </div>
    </div>
</section>
...
<section class="mb-20">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5">
        <div class="shadow-lg p-3 sm:p-10 rounded-lg">
            <img src="{{asset('img/Screen1.png')}}" alt="About page preview">
        </div>
        <div class="shadow-lg p-3 sm:p-10 rounded-lg">
            <img src="{{asset('img/Screen2.png')}}" alt="Pricing page preview">
        </div>
        {{-- <div class="shadow-lg p-3 sm:p-10 rounded-lg row-span-2">
            <img src="{{asset('img/Screen2.png')}}" alt="Landing page preview">
        </div> --}}
    </div>
</section>
