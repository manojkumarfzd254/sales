            ...
            <table class="table table-hover table-responsive-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{asset($user->qrcode)}}" style="width:100px;hight:100px;">
                        </td>
                        {{-- <td>
                        ...
                        <td class="text-end">
                            @if ($user->qrcode != null)
                                <a href="{{asset($user->qrcode)}}" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a>
                            @else
                                <a href="{{route('backend.users.generateQrCode',['id'=>$user->id])}}" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i> </a>
                            @endif
