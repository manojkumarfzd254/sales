 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      ...
                      <div class="inbox-body">
                          <a href="javascript:void(0)" onclick="$('#composeModal').modal('show')" title="Compose"    class="btn btn-compose">
                              Compose
                          </a>
                          <!-- Modal -->
                              ...
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <button onclick="$('#composeModal').modal('hide')" class="close" type="button">×</button>
