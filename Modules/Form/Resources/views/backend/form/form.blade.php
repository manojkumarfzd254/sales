...
<div class="row mb-3">
    {{-- <div class="col-md-6">
        <div class="form-group">
            ...
            $field_lable = __("Parent Business Category");
    ...
    <div class="col-12 col-md-4">
        <div class="form-group">
            ...
            $field_lable = label_case("Form Name");
    ...
    <div class="col-12 col-md-4">
        <div class="form-group">
            <?php
            $field_name = 'heading_type';
            $field_lable = label_case("Heading Type");
            $field_placeholder = $field_lable;
            $required = "required";
            ...
            {{ html()->select($field_name)->options($options)->class('form-control select2-heading')->attributes(["$required"]) }}
        </div>
    </div>
    <div class="col-12 col-md-4">
        <div class="form-group">
    ...
    <div class="col-12 col-md-12">
        <div class="form-group">
            <?php
            $field_name = 'heading_data';
            $field_lable = label_case($field_name);
            $field_placeholder = "Heading Data";
            $required = "required";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
            {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required"]) }}
    ...
    <div class="col-12 col-md-12">
        <div class="form-group">
            ...
            {{ html()->textarea($field_name)->class('form-control ckeditor') }}
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('.select2-heading').select2({theme: "bootstrap",placeholder:"Select a option"});
