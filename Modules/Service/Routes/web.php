...
Route::group(['namespace' => '\Modules\Service\Http\Controllers\Frontend', 'as' => 'frontend.', 'middleware' => 'web', 'prefix' => ''], function () {
    ...
    Route::get("$module_name/products/{id}/{slub?}", ['as' => "$module_name.products-show", 'uses' => "$controller_name@productsShow"]);
});
...
* --------------------------------------------------------------------
*/
Route::group(['namespace' => '\Modules\Service\Http\Controllers\Backend', 'as' => 'backend.', 'middleware' => ['web', 'auth', 'can:view_backend'], 'prefix' => 'admin'], function () {
    /*
