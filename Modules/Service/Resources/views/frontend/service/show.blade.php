...
@section('title') {{$$module_name_singular->title}} @endsection
...
<section class="bg-gray-100 text-gray-600 body-font px-20">
    <div class="container mx-auto flex px-5 py-8 sm:py-16 md:flex-row flex-col items-center">
        <div class="lg:flex-grow sm:w-4/12 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            @if ($$module_name_singular->type == 'Service')
                <p class="mb-8 leading-relaxed">
                    <a href="{{route('frontend.form.enquiry-form',['id'=>$$module_name_singular->form_id])}}" class="btn btn-primary btn-sm">Enquiry Form</a>
                </p>
            @else
                <p class="mb-8 leading-relaxed">
                    <a href="{{route('frontend.service.products-show',['id'=>$$module_name_singular->id,'slub'=>strtolower(str_replace(' ','-',$$module_name_singular->title))])}}" class="btn btn-primary btn-sm">View Products</a>
                </p>
            @endif
        ...
        <div class="sm:w-8/12">
            <img class="object-cover object-center rounded shadow-md" alt="{{$$module_name_singular->title}}" src="{{url($$module_name_singular->icon)}}">
        </div>
    </div>
</section>
        ...
        <div class="flex flex-col lg:flex-grow sm:w-8/12 sm:pr-8">
            ...
            <div class="py-5">
                <div class="flex flex-row justify-around content-center items-center ">
                    ...
                    <div>
                        @php $title_text = $$module_name_singular->title; @endphp
