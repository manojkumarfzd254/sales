...
Route::group(['namespace' => 'App\Http\Controllers\Backend', 'prefix' => 'admin', 'as' => 'backend.', 'middleware' => ['auth', 'can:view_backend']], function () {
    ...
    */
    $module_name = 'users';
    $controller_name = 'UserController';
    // history show by rahulya
    Route::get("$module_name/history_data/", ['as' => "$module_name.history_data", 'uses' => "$controller_name@history_data"]);
    Route::get("$module_name/recenthistory_data/", ['as' => "$module_name.recenthistory_data", 'uses' => "$controller_name@recenthistory_data"]);
    //end
    Route::get("$module_name/generate-qrcode/{id}", ['as' => "$module_name.generateQrCode", 'uses' => "$controller_name@generateQrCode"]);
